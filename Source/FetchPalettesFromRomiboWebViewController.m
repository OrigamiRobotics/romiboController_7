...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView == self.paletteSelectorTableView){
        ...
        self.myPaletteIds[ @(indexPath.row)] = splitTitleAndId[1];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        [self.palettesSelectedToFetch addObject:@(indexPath.row)];
...
-(void)tableView:(UITableView *)tableView didDeselectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        [self.palettesSelectedToFetch removeObject:@(indexPath.row)];
        [self updateNumberOfPalettesSelctedToFetchLabel];
    });
